...
//
// Usage:
//   PERMISSION_CONTRACT_VERSION=v1.9.2 node scripts/codegen-permissions.mjs
//   # default version: v1.9.2
//
...
const CONTRACT_VERSION = process.env.PERMISSION_CONTRACT_VERSION ?? 'v1.9.2';
