...
//
// Usage:
//   PERMISSION_CONTRACT_VERSION=v1.10.0 node scripts/codegen-permissions.mjs
//   # default version: v1.10.0
//
...
const CONTRACT_VERSION = process.env.PERMISSION_CONTRACT_VERSION ?? 'v1.10.0';
